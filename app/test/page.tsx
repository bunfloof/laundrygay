...
const LaundryMachineSelector: React.FC = () => {
  ...
  const fetchAvailableClients = async () => {
    try {
      const res = await fetch('https://128-114-34-10.ucsc.gay/clients');
...
return (
  <div className="flex items-center justify-center bg-background min-h-screen" style={{ minHeight: 'calc(var(--vh, 1vh) * 100)' }}>
    <Card className="w-full max-w-md">
      <CardHeader className="text-2xl font-bold">ACAB</CardHeader>
      <CardContent>
      ...
      <CardFooter className="text-center text-sm text-foreground flex justify-between items-center">
        <Popover>
