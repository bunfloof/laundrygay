...
const TabbedCardInterface: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (storedSelectedAPI !== null) {
      setSelectedAPI(storedSelectedAPI);
    }
  }, []);
  ...
  return (
    <div className="flex items-center justify-center bg-background min-h-screen" style={{ minHeight: 'calc(var(--vh, 1vh) * 100)' }}>
      <Card className="w-full max-w-md border-0 shadow-none">
        ...
        <CardFooter className="text-sm text-foreground flex justify-between items-center pt-4">
          <div className="flex space-x-4">
            <div className="p-0 h-auto text-sm text-muted-foreground hover:text-foreground transition-colors">
            <Dialog>
              <DialogTrigger asChild>
                <div className="p-0 h-auto text-sm text-muted-foreground hover:text-foreground transition-colors cursor-pointer">
                  About
                </div>
              </DialogTrigger>
              <DialogContent className="sm:max-w-[425px] p-0">
                <div className="py-5">
                  <div className='text-center flex flex-col items-center pb-10'>
                    ...
                    {/* <p className="text-sm px-5 p-2">And the BrightAI database is somewhere on the torrent network. Sharing is caring.</p> */}
                  </div>
              </DialogContent>
            </Dialog>
            </div>
              ...
              <DialogContent className="sm:max-w-[425px]">
                ...
                <div className="py-1">
                  ...
                  <RadioGroup
                    ...
                    onValueChange={handleSetDefaultTab}
                  >
                ...
                <div className="py-1">
                  ...
                  <RadioGroup
                    value={selectedAPI}
                    onValueChange={handleSetSelectedAPI}
                  >
